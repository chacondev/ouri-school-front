...
export const routes: Routes = [
  ...
  // ---- DONO ----
  {
    ...
    children: [
      ...
      { path: 'calendario', loadComponent: () => import('./features/dono/calendario/calendario').then(m => m.CalendarioDonoComponent) },
  ...
  // ---- PROFESSOR ----
  {
    ...
    children: [
      ...
      { path: 'calendario', loadComponent: () => import('./features/professor/calendario/calendario').then(m => m.CalendarioProfessorComponent) },
  ...
  // ---- ALUNO ----
  {
    ...
    children: [
      ...
      { path: 'calendario', loadComponent: () => import('./features/aluno/calendario/calendario').then(m => m.CalendarioAlunoComponent) },
